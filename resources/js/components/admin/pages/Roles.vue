    ...
    <v-container fluid>
      <v-card>
        <v-row justify="space-between" class="px-4 pt-2 pb-2">
          <div class="header">
            <v-icon color="primary" x-large>mdi-account-network</v-icon>
      ...
      <v-row>
        <v-col lg="4" sm="12" v-for="role in roles" :key="role.id">
          <v-card>
            <v-card-title>
              <v-icon color="primary">mdi-account</v-icon> {{ role.name }}
            </v-card-title>
                ...
                <div class="header">
                  ...
                  <div class="buttons">
                    <v-btn
                      ...
                      v-if="hasPermission('Edit roles')"
                    >
                      <v-icon small>mdi-plus</v-icon> {{$t('Edit')}}
                    </v-btn>
                  </div>
                </div>
            ...
            axios
              ...
              .then(() => {
                this.$notify({
                  ...
                  text: this.$t('Roles') + ' ' + $t('updated successfully.'),
                });
              })
