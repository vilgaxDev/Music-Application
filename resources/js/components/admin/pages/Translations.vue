    ...
    <div class="">
        <v-card outlined>
            <v-card-title class="justify-space-between">
                <div class="left">
                    <v-icon color="primary" x-large>mdi-translate</v-icon>
                    <v-btn
                        class="mx-2"
                        dark
                        small
                    ...
                    >
                        <v-icon>mdi-plus</v-icon> {{ $t("New Language") }}
                    </v-btn>
                </div>
            </v-card-title>
            <v-spacer></v-spacer>
        ...
        <v-card outlined>
            <v-card-title>
                <v-card-actions>
                    ...
                    >
                        <v-icon>mdi-plus</v-icon> {{ $t("New Translation") }}
                    </v-btn>
                    <v-btn
                        class="mx-2"
                        small
            ...
            <v-dialog
                ...
                @click:outside="createLangDialogLoading ? _ :resetEditDialog"
            >
                <edit-dialog
                        ...
                        <v-container>
                            <v-container>
                                ...
                                <veutify-select
                                    ...
                                    messages="Select a similar language to fill the translations. You can leave it empty."
                                    :items="locales"
                                    item-value="locale"
                                    item-text="name"
                                    outlined
