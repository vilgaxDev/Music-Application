                ...
                <div class="info-wrapper d-flex">
                    ...
                    <div class="badge" v-if="user.plan" :title="$t('Subscribed to') + ' '  + user.plan.name + ' plan'">
                        <v-btn outlined small color="primary">
                            <v-icon left v-if="user.plan.badge">mdi-{{ user.plan.badge }}</v-icon>
                            {{ user.plan.name }}
                        </v-btn>
                    </div>
                </div>
        ...
        <template v-slot:main>
            <div
                ...
                v-if="
                    user.mostPlayed.length ||
                        user.followed_artists.length ||
                        user.followed_playlists.length ||
            ...
            >
                <div class="most-played" v-if="user.mostPlayed.length">
                    ...
                    <div class="content">
                        <song-list :songs="mostPlayedSpliced"></song-list>
                    </div>
