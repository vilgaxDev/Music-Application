<template>
  <div class="podcast-container" v-if="podcast">
    <div class="podcast__header">
      <div class="podcast__info">
        ...
        <div class="podcast__text">
          ...
          <div class="" v-if="podcast.artist && podcast.artist.id">
            ...
            <div class="podcast__description-lg">
            {{ $t(podcast.description) }} 
          </div>
        </div>
      </div>
          <div class="podcast__description-sm">
            {{ $t(podcast.description) }} 
          </div>
      <div class="podcast__actions">
        ...
        <div class="follow-button">
          <v-btn color="secondary" rounded @click="follow()" v-if="isFollowed">
            {{ $t("Following") }}
          </v-btn>
          <v-btn color="secondary" rounded @click="follow()" v-else>
            {{ $t("Follow") }}
          </v-btn>
        </div>
      </div>
      ...
      <div class="podcast__episodes" v-if="podcast.episodes.length">
        ...
        <div class="episodes">
          <v-card
            ...
            :key="episode.id"
            @click="$store.dispatch('playEpisode',{ episode, reset: true })"
          >
                ...
                <div class="infos">
                  <div class="title">
                    <div class="icon">
                      ...
                      <template v-else>
                        ...
                        >
                        <v-icon class="icon__play" large>mdi-play</v-icon>
                      </template>
                    </div>
                  ...
                  <div class="times">
                    <div class="created_at">
                      {{ formatEpisodeDate(episode.created_at) }}
                    </div>
                    <div class="duration">
