    ...
    >
        <v-card class="p-3">
            <v-card-title class="header">
                <v-icon color="primary" class=" pr-3" x-large>mdi-cog</v-icon>
                ...
                <v-col lg="9" sm="6">
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12" lg="6">
                                <div class="card-title card-title-small py-1">
                                    {{ $t("Update Password") }}
                                </div>
                                <v-divider></v-divider>
                                <v-text-field
                            ...
                            <v-col
                                cols="12"
                                lg="6"
                                v-if="$store.getters.getSettings.enableRealtime"
                            >
                                <div class="card-title card-title-small  py-1">
                                    {{ $t("Privacy") }}
                                </div>
                    ...
                    >
                        ...
                        <v-btn
                            ...
                            class="mt-4"
                            v-if="
                                $store.getters.getUser.requested_artist_account
                            "
            ...
            <v-card class="p-3  mx-auto">
                <v-card-title class="d-block">
                    <div class="text-align-center">
                        ...
                        <div class="sub">
                            {{ $t("This request can only be submitted ones.") }}
                        </div>
                    </div>
                </v-card-title>
                <v-row class="px-4">
