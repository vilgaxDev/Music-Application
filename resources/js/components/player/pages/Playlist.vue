<template>
    <fixed-left v-if="playlist">
            ...
            <div class="info-wrapper">
                ...
                <div class="title justify-between">
                    ...
                    <div class="menu-toggle" v-if="playlist.songs.length">
                        <v-icon @click="showMenu = !showMenu">mdi-menu</v-icon>
                        <abs-menu
                            v-if="showMenu"
        ...
        <template v-slot:main>
            ...
            <div
                ...
                v-if="playlist.songs && playlist.songs.length"
            >
                <playlist-song-list
                    :mine="
                        playlist.user &&
    ...
    <empty-page
        ...
        :sub="$t('Playlist does not exist or maybe it is not available for public access. who knows!')"
        img="peep-68.png"
    >
...
export default {
    ...
    methods: {
        ...
        followPlaylist() {
            if (!this.isFollowed) {
                this.$store
                    .dispatch("followPlaylist", this.playlist.id)
                    .catch(() => {});
            } else {
                this.$store
                    .dispatch("unFollowPlaylist", this.playlist.id)
                    .catch(() => {});
            }
        },
        playlistUpdated() {
