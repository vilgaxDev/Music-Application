...
class LanguageController extends Controller
{
    ...
    {
        $en_messages = Translation::select('key', 'value')->where('locale', 'en')->get();
        if( $locale !== 'en' ) {
            $locale_messages = Translation::select('key', 'value')->where('locale', $locale)->get();
    ...
    public function saveMessages(Request $request, $locale)
    {
        ...
        Artisan::call('translations:export');
        return Translation::where('locale', $locale)->orderBy('created_at')->get();
    }
